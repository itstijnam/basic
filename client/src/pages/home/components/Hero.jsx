      ...
      <div className="hero_top">
        <div className="HT_content">
          <div className="heading">
            ...
            <p className='hero_content'>Step into a world where the art of Interior Design is meticulously crafted to bring together timeless elegance and cutting-edge
        ...
        <div className="hero_footer">
          ...
          <div className="footer_right_box">
            <div className="_footer_image_section">
